...
#define STRING_CONFIG_H_AUTHOR "Benjamin Godard" // Who made the changes.
...
//from FOPDT model - kp=.39 Tp=405 Tdead=66, Tc set to 79.2, aggressive factor of .15 (vs .1, 1, 10)
    #define  DEFAULT_bedKp 154.55
    #define  DEFAULT_bedKi 29.02
    #define  DEFAULT_bedKd 205.75
...
#define X_HOME_DIR 1 // max end stop
#define Y_HOME_DIR -1 // min end stop
#define Z_HOME_DIR -1 // min end stop
...
//    You must specify the X & Y coordinates of all 3 points
  ...
  // Note: this feature occupies 10'206 byte
    ...
    #define RIGHT_PROBE_BED_POSITION 154 // XHome - X_PROBE_OFFSET_FROM_EXTRUDER
    #define BACK_PROBE_BED_POSITION 152 // YMax - Y_PROBE_OFFSET_FROM_EXTRUDER
  ...
  #define Z_RAISE_BETWEEN_PROBINGS 0 //7  //How much the extruder will be raised when traveling from between next probing points
  ...
  #define Z_RAISE_BEFORE_RETRACTING 10 //7 // (in mm) raise Z before retracting probe
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,4000,104}  // Steps per unit
#define DEFAULT_MAX_FEEDRATE          {350, 350, 2, 22}    // (mm/sec)
...
#define CUSTOM_M_CODES
  ...
  #define Z_PROBE_OFFSET_RANGE_MIN -2.8
...
#define ABS_PREHEAT_HOTEND_TEMP 212
...
#define SERVO_ENDSTOP_ANGLES {0,0, 0,0, 147,50} // X,Y,Z Axis Extend and Retract angles
